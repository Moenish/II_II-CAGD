        ...
        */
        ...
        // Project
            ...
            // Patches
                ...
                connect(_side_widget->patchAppearanceCheckBox_PatchDirections, SIGNAL(clicked(bool)), _gl_widget, SLOT(patchAppearanceDoPatchDirections(bool)));
                connect(_side_widget->patchAppearanceCheckBox_Lines, SIGNAL(clicked(bool)), _gl_widget, SLOT(patchAppearanceDoLines(bool)));
