...
// special constructor
ParametricCurve3::ParametricCurve3(const RowMatrix<Derivative> &derivatives, GLdouble u_min, GLdouble u_max) : _u_min(u_min), _u_max(u_max), _derivatives(derivatives)
{
}
