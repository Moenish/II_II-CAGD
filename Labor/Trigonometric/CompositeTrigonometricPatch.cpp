...
namespace cagd
{
    ...
    GLboolean CompositeTrigonometricPatch::insertNewPatch(Material* material, const vector<DCoordinate3>& controlPoints)
    {
        ...
        _u_isoparametric_lines[index] = cur_patch->GenerateUIsoparametricLines(_uIsoLineCount, 2, _uDivPointCount);
        _v_isoparametric_lines[index] = cur_patch->GenerateVIsoparametricLines(_vIsoLineCount, 2, _vDivPointCount);
