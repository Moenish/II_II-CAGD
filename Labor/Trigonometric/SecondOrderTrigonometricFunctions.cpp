...
GLdouble SOTF::f2_1(GLdouble alpha, GLdouble t)
{
    ...
    //-(sin(t/2)*(2*cos(alpha/2)*cos((alpha-t)/2)*sin(t/2)^2+((2*cos(alpha/2)^2+1)*cos((alpha-t)/2)*sin((alpha-t)/2)-6*cos(alpha/2)*sin((alpha-t)/2)*cos(t/2))*sin(t/2)+(-2*cos(alpha/2)^2-1)*sin((alpha-t)/2)^2*cos(t/2)))/sin(alpha/2)^4
    return -(sin(c2) * (2.0 * cos(c1) * cos(c3) * sin(c2) * sin(c2) + ((2.0 * cos(c1) * cos(c1) + 1.0) * cos(c3) * sin(c3) - 6.0 * cos(c1) * sin(c3) * cos(c2)) * sin(c2) + (-(2.0 * cos(c1) * cos(c1)) - 1.0) * sin(c3) * sin(c3) * cos(c2))) / sin4Alpha;
...
GLdouble SOTF::f3_1(GLdouble alpha, GLdouble t)
{
    ...
    //(2 * cos(t/2) * sin(t/2)^3) / sin(alpha)^4
...
GLdouble SOTF::f2_2(GLdouble alpha, GLdouble t)
{
    ...
    //return -(8.0 * cos(alpha/2)*sin((alpha-t)/2)*sin(t/2)^3+(12*cos(alpha/2)*cos((alpha-t)/2)*cos(t/2)+(4*cos(alpha/2)^2+2)*sin((alpha-t)/2)^2+(-2*cos(alpha/2)^2-1)*cos((alpha-t)/2)^2)*sin(t/2)^2+((8*cos(alpha/2)^2+4)*cos((alpha-t)/2)*sin((alpha-t)/2)*cos(t/2)-12*cos(alpha/2)*sin((alpha-t)/2)*cos(t/2)^2)*sin(t/2)+(-2*cos(alpha/2)^2-1)*sin((alpha-t)/2)^2*cos(t/2)^2)/(2*sin(alpha/2)^4)
    return -(8.0 * cos(c1) * sin(c3) * sin3T + (12.0 * cos(c1) * cos(c3) * cos(c2) + (4.0 * cos(c1) * cos(c2) + 2.0) * sin(c3) * sin(c3) + (- 2.0 * cos(c1) * cos(c1) - 1.0) * cos(c3) * cos(c3)) * sin(c2) * sin(c2) + ((8.0 * cos(c1) * cos(c1) + 4.0) * cos(c3) * sin(c3) * cos(c2) - 12.0 * cos(c1) * sin(c3) * cos(c2) * cos(c2)) * sin(c2) + (-(2.0 * cos(c1) * cos(c1)) - 1.0) * sin(c3) * sin(c3) * cos(c2) * cos(c2)) / (2.0 * sin4Alpha);
}
GLdouble SOTF::f3_2(GLdouble alpha, GLdouble t)
{
    ...
    GLdouble sin2T = sin(c2) * sin(c2);
//    GLdouble sin3T = sin2T * sin(c2);
    GLdouble sin4T = sin2T * sin2T;

    return ((3.0 * cos(c2) * cos(c2) * sin2T) - sin4T) / sin4Alpha;
